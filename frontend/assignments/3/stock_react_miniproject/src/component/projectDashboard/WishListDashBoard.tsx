    ...
    <div className={classes.dashBoardContainer}>
      ...
      <ul>
        ...
        {displayedStocks.map((stock, index) => (
            <li style={{borderBottom:"2px solid #cccdce",margin:"0 1rem"}} key={index}>
          <div className={classes.low_first_part_title_dashboard}>
          <Link to={`/market/${stock.stock_name}`} style={{textDecoration:"none",color:"#000000"}}>
            {stock.stock_symbol}
          </Link>
            </div>
            <ListStockItem basePrice={stock.base_price} stockName= {stock.stock_name} status={stock.stock_status}></ListStockItem>
          </li>
        ))}
      </ul>
